<template>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-10">
    <h1 class="text-2xl font-bold text-gray-700">Tarım Tavsiyeleri</h1>
    <!-- This example requi"res Tailwind CSS v2.0+ -->
    <div class="bg-white shadow rounded-lg mt-5">
      <div class="px-4 py-5 sm:p-6">
        <!-- This example requires Tailwind CSS v2.0+ -->
        <blog-card-component @readMoreBlog="openBlogModal"></blog-card-component>
      </div>
    </div>
  </div>
        ...
        >
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500">{{ selectedBlog.content }}</p>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    beforeEnter() {
      document.querySelector(`#blog-modal`).classList.remove("hidden")
    },
    afterLeave() {
      document.querySelector(`#blog-modal`).classList.add("hidden")
    },
  },
